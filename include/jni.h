...
struct _JavaVM {
    ...
    { return functions->AttachCurrentThread(this, (JNIEnv**) p_env, thr_args); }
 ...
 */
JNIIMPORT jint JNICALL JNI_GetDefaultJavaVMInitArgs(void*);
JNIIMPORT jint JNICALL JNI_CreateJavaVM(JavaVM**, JNIEnv**, void*);
